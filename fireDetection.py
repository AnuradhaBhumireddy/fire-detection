...
def send_mail_function(): # defined function to send mail post fire detection using threading
    ...
    recipientmail = "kandi.narayanareddy3@gmail.com" # recipients mail
    ...
    try:
        ...
        server.ehlo()
        server.starttls()
        server.login("20ne1a0468@gmail.com", '9618559601') # Senders mail ID and password
        server.sendmail('kandi.narayanareddy3@gmail.com', recipientmail, "Warning fire accident has been reported") # recipients mail with mail message
